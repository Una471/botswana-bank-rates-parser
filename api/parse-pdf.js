    ...
    try {
        ...
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${GEMINI_API_KEY}`, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `You are a bank rate extraction expert. Extract ALL interest rates and return ONLY valid JSON.
...
Return this exact structure:
{
  ...
  "Mortgage Rate Min": "Put text here like 'Prime + 2%'",
  "Mortgage Rate Max": "Put text here like 'Prime + 5%'",
  "Personal Loan Min": "string",
  "Personal Loan Max": "string"
}

CRITICAL: 'Mortgage Rate Min', 'Mortgage Rate Max', 'Personal Loan Min', and 'Personal Loan Max' MUST be returned as strings (in quotes), NOT numbers. If a rate is 'Prime + 2%', write 'Prime + 2%'.`
                    }]
                }],
                generationConfig: {
                    temperature: 0.1,
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // We removed the auto-save. Now the PDF just displays on your dashboard.
        // You only save to Airtable when you click the "Approve" button.
        res.status(200).json({ 
            success: true, 
            message: `✅ PDF processed. Please review and click Approve.`,
            data: extractedData
        });
